...
var fileDescriptor_33c57e4bae7b9afd = []byte{
	...
	,
}
...
func (m *Message) MarshalToSizedBuffer(dAtA []byte) (int, error) {
	...
	var l int
	_ = l
	if len(m.DeleteLoad) > 0 {
		for iNdEx := len(m.DeleteLoad) - 1; iNdEx >= 0; iNdEx-- {
			{
				size, err := m.DeleteLoad[iNdEx].MarshalToSizedBuffer(dAtA[:i])
				if err != nil {
					return 0, err
				}
				i -= size
	...
	if len(m.BackupLoad) > 0 {
		for iNdEx := len(m.BackupLoad) - 1; iNdEx >= 0; iNdEx-- {
			{
				size, err := m.BackupLoad[iNdEx].MarshalToSizedBuffer(dAtA[:i])
				if err != nil {
					return 0, err
				}
				i -= size
...
func (m *Message_BackupLoad) Marshal() (dAtA []byte, err error) {
	size := m.Size()
	dAtA = make([]byte, size)
	n, err := m.MarshalToSizedBuffer(dAtA[:size])
	if err != nil {
...
func (m *Message_BackupLoad) MarshalTo(dAtA []byte) (int, error) {
	size := m.Size()
	return m.MarshalToSizedBuffer(dAtA[:size])
}

func (m *Message_BackupLoad) MarshalToSizedBuffer(dAtA []byte) (int, error) {
	i := len(dAtA)
	_ = i
	var l int
	_ = l
	...
	if len(m.IdHash) > 0 {
		...
		i = encodeVarintMessage(dAtA, i, uint64(len(m.IdHash)))
		i--
		dAtA[i] = 0x12
	}
	if len(m.TargetPeerList) > 0 {
		for iNdEx := len(m.TargetPeerList) - 1; iNdEx >= 0; iNdEx-- {
			i -= len(m.TargetPeerList[iNdEx])
			copy(dAtA[i:], m.TargetPeerList[iNdEx])
			i = encodeVarintMessage(dAtA, i, uint64(len(m.TargetPeerList[iNdEx])))
			i--
			dAtA[i] = 0xa
		}
	}
...
func (m *Message_DeleteLoad) Marshal() (dAtA []byte, err error) {
	size := m.Size()
	dAtA = make([]byte, size)
	n, err := m.MarshalToSizedBuffer(dAtA[:size])
	if err != nil {
...
func (m *Message_DeleteLoad) MarshalTo(dAtA []byte) (int, error) {
	size := m.Size()
	return m.MarshalToSizedBuffer(dAtA[:size])
}

func (m *Message_DeleteLoad) MarshalToSizedBuffer(dAtA []byte) (int, error) {
	i := len(dAtA)
	_ = i
	var l int
	_ = l
	if len(m.Cid) > 0 {
		for iNdEx := len(m.Cid) - 1; iNdEx >= 0; iNdEx-- {
			...
			i = encodeVarintMessage(dAtA, i, uint64(len(m.Cid[iNdEx])))
			i--
			dAtA[i] = 0x12
		}
	}
...
func (m *Message) Size() (n int) {
	...
	if len(m.BackupLoad) > 0 {
		for _, e := range m.BackupLoad {
			l = e.Size()
			n += 1 + l + sovMessage(uint64(l))
		}
	}
	if len(m.DeleteLoad) > 0 {
		for _, e := range m.DeleteLoad {
			l = e.Size()
			n += 1 + l + sovMessage(uint64(l))
		}
	}
...
func (m *Message_BackupLoad) Size() (n int) {
	if m == nil {
		return 0
	}
	var l int
	_ = l
	if len(m.TargetPeerList) > 0 {
		for _, s := range m.TargetPeerList {
			l = len(s)
			n += 1 + l + sovMessage(uint64(l))
		}
	}
...
func (m *Message_DeleteLoad) Size() (n int) {
	if m == nil {
		return 0
	}
	var l int
...
func (m *Message) Unmarshal(dAtA []byte) error {
	...
	for iNdEx < l {
		...
		case 6:
			if wireType != 2 {
				return fmt.Errorf("proto: wrong wireType = %d for field BackupLoad", wireType)
			}
			var msglen int
			for shift := uint(0); ; shift += 7 {
				if shift >= 64 {
			...
			m.BackupLoad = append(m.BackupLoad, &Message_BackupLoad{})
			if err := m.BackupLoad[len(m.BackupLoad)-1].Unmarshal(dAtA[iNdEx:postIndex]); err != nil {
				return err
			}
			iNdEx = postIndex
		case 7:
			if wireType != 2 {
				return fmt.Errorf("proto: wrong wireType = %d for field DeleteLoad", wireType)
			}
			var msglen int
			for shift := uint(0); ; shift += 7 {
				if shift >= 64 {
			...
			m.DeleteLoad = append(m.DeleteLoad, &Message_DeleteLoad{})
			if err := m.DeleteLoad[len(m.DeleteLoad)-1].Unmarshal(dAtA[iNdEx:postIndex]); err != nil {
				return err
			}
			iNdEx = postIndex
		default:
...
func (m *Message_BackupLoad) Unmarshal(dAtA []byte) error {
	l := len(dAtA)
	iNdEx := 0
	for iNdEx < l {
		preIndex := iNdEx
		...
		wireType := int(wire & 0x7)
		if wireType == 4 {
			return fmt.Errorf("proto: BackupLoad: wiretype end group for non-group")
		}
		if fieldNum <= 0 {
			return fmt.Errorf("proto: BackupLoad: illegal tag %d (wire type %d)", fieldNum, wire)
		}
		switch fieldNum {
		case 1:
			if wireType != 2 {
				return fmt.Errorf("proto: wrong wireType = %d for field TargetPeerList", wireType)
			}
			...
			m.TargetPeerList = append(m.TargetPeerList, string(dAtA[iNdEx:postIndex]))
			iNdEx = postIndex
		case 2:
			if wireType != 2 {
...
func (m *Message_DeleteLoad) Unmarshal(dAtA []byte) error {
	l := len(dAtA)
	iNdEx := 0
	for iNdEx < l {
		preIndex := iNdEx
		...
		wireType := int(wire & 0x7)
		if wireType == 4 {
			return fmt.Errorf("proto: DeleteLoad: wiretype end group for non-group")
		}
		if fieldNum <= 0 {
			return fmt.Errorf("proto: DeleteLoad: illegal tag %d (wire type %d)", fieldNum, wire)
		}
		switch fieldNum {
		case 1:
			if wireType != 2 {
		...
		case 2:
			...
			m.Cid = append(m.Cid, string(dAtA[iNdEx:postIndex]))
			iNdEx = postIndex
		default:
			iNdEx = preIndex
			skippy, err := skipMessage(dAtA[iNdEx:])
